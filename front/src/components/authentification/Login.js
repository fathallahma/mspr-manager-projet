...
export default function Login({ onLogin }) {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${OPENFAAS_GATEWAY}/function/authenticate-user`, {
                username: username,
                password: password,
                ...
                switch (status) {
                    case 400:
                        if (data.requires_2fa) {
                            ...
                            setErrorMessage("Données manquantes (nom d'utilisateur ou mot de passe)");
                        }
                        break;
                    case 401:
                    ...
                    case 403:
                        if (data.expired) {
                            setErrorMessage("Votre compte a expiré (inactif depuis plus de 6 mois)");
                        } else {
                            setErrorMessage("Accès refusé");
                        }
                        break;
                    default:
                        setErrorMessage(data.error || "Erreur serveur lors de la connexion");
                }
            } else {
                        ...
                        <div className="security-info">
                            <div className="security-badge">
                                ...
                                <div>
                                    ...
                                    <small>Mots de passe 24 caractères • 2FA TOTP • Expiration 6 mois</small>
                                </div>
                            </div>
                        </div>
                    </>
